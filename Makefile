...
worker:
	@ansible-playbook -i inventory/hosts -e 'dd_api_key=$(DD_API_KEY) mount_point=$(MOUNT_POINT) $(RAID_OPTS) $(LAUNCH_DEAMONS_OPTS) $(LAUNCH_THORNODE_OPTS)' $(TARGET_OPTS) worker.yml
